...
export default function App() {
  return (
    <main className="min-h-screen selection:bg-neon-blue selection:text-black relative">
      ...
      <Hero 
        showChatButton={SHOW_CHAT_SECTION} 
      />
      ...
      <div className="space-y-16 lg:space-y-24 pb-32">
        ...
        {SHOW_CHAT_SECTION && <ScrollReveal><AIAssistant /></ScrollReveal>}
      </div>
      ...
      <footer className="py-12 px-4 lg:px-24 border-t border-white/5 bg-black/20 backdrop-blur-md relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-[0.2em] text-xl uppercase neon-text">Amil Asaad</span>
          </div>
          ...
          <div className="flex gap-8 text-[10px] font-mono uppercase tracking-[0.3em]">
            <a target='_blank' href="https://drive.google.com/file/d/1BlANI4367Wlj39qfohj6ZKpohpGYBKZl/view?usp=sharing" className="hover:neon-text transition-colors">Get_Resume</a>
          </div>
        </div>
      </footer>
    </main>
