...
const CERTIFICATES = [
  {
    ...
    id: "*******552",
    description:
      "Validated expertise in designing, building, and managing complex APIs and integrations using Anypoint Platform.",
  ...
  },
  {
    ...
    id: "********rFTF",
    description:
      "Comprehensive training covering end-to-end MuleSoft integration, Anypoint Studio, and advanced API lifecycle management.",
    verifyUrl:
      "https://lms.cognixia.com/moodle/mod/customcert/verify_certificate.php",
    icon: <Award className="w-8 h-8 text-neon-blue" />,
  ...
  },
  {
    ...
    id: "********1735",
    description:
      "Deep dive into Java backend development, focusing on dependency injection, ORM mapping, and rapid application development with Spring Boot.",
    verifyUrl:
      "https://www.udemy.com/certificate/UC-5694093c-c4af-4d72-9b11-d5c7c4d41735",
    icon: <Award className="w-8 h-8 text-neon-blue" />,
  ...
  },
  {
    ...
    id: "********59b9",
    description:
      "Mastery of full-stack development involving responsive Angular frontends and robust Java-based RESTful microservices.",
    verifyUrl:
      "https://www.udemy.com/certificate/UC-152cc4c0-2b47-4ee8-98ca-63fe588c59b9",
    icon: <Award className="w-8 h-8 text-neon-blue" />,
  ...
  },
  {
    ...
    id: "********4ab9",
    description:
      "Implementation of large-scale data processing using the Spark framework, focusing on RDDs, DataFrames, and Big Data analytics.",
    verifyUrl:
      "https://www.udemy.com/certificate/UC-6146b338-805a-4dd8-8ed9-da764df4ab9a",
    icon: <Award className="w-8 h-8 text-neon-blue" />,
  ...
  },
  {
    ...
    id: "********0051",
    description:
      "Foundational knowledge in network security, threat mitigation, and best practices for securing digital information and communications.",
    verifyUrl: "",
    icon: <Award className="w-8 h-8 text-neon-blue" />,
          ...
          >
            <div className="relative h-40 lg:h-48 overflow-hidden">
              ...
              <div className="absolute top-4 right-4 text-right">
                <span className="text-[8px] font-mono text-gray-900 uppercase tracking-widest block mb-0.5">
                  Issue_Date
                </span>
            ...
            <div className="p-6 lg:p-8 flex-1 flex flex-col">
              <div className="mb-4">
                <h3 className="text-xl lg:text-2xl font-bold tracking-tight text-white mb-2 group-hover:neon-text transition-colors">
                  {cert.title}
                </h3>
                <span className="inline-block px-2 py-0.5 bg-neon-blue/10 rounded border border-neon-blue/20 text-[9px] font-mono text-neon-blue uppercase tracking-widest">
                  {cert.subtitle}
                </span>
              </div>
