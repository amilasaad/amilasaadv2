...
import { ExternalLink, Zap, Shield, Award, CheckCircle, RefreshCw, Trophy } from 'lucide-react';
...
const HIGHLIGHTS = [
  ...
  },
  {
    ...
    image: "src/images/pitch-spot-award.JPG",
  },
  {
    id: "03",
    ...
    image: "src/images/innovation-champion-award.JPG",
  },
  {
    id: "04",
    ...
    stats: "Team Utilized",
    image: "src/images/mbtc-logo.jpg",
  },
  {
    id: "05",
    ...
    stats: "MCD - Level 1",
    image: "src/images/mcd-lvl-1-cert.jpg",
  },
  {
    id: "06",
    ...
    stats: "Rated Superb",
    image: "src/images/globe-logo.jpg",
  },
];
...
export default function Highlights() {
  ...
  return (
    <section className="py-8 lg:py-16 px-4 lg:px-24 relative z-10">
      ...
      >
        <h2 className="text-3xl lg:text-5xl font-bold tracking-tighter mb-4 neon-text uppercase">Key_Highlights</h2>
        ...
        {HIGHLIGHTS.map((item) => (
          ...
          >
            ...
            <div className="p-6 lg:p-10 pt-6">
              ...
              <h3 className="text-xl lg:text-2xl font-bold mb-3 lg:mb-4 tracking-tight group-hover:neon-text transition-all">{item.title}</h3>
              <p className="text-[11px] lg:text-sm text-gray-400 mb-6 lg:mb-8 font-mono leading-relaxed uppercase tracking-wider group-hover:text-gray-300">
                {item.description}
              </p>
              
              <div className="flex items-center justify-between pt-4 lg:pt-6 border-t border-white/5">
                <span className="text-[9px] lg:text-[10px] font-mono text-neon-blue uppercase tracking-[0.2em] font-bold">{item.stats}</span>
              </div>
            </div>
          </motion.div>
        ))}
